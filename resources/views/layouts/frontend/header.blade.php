...
<head>
    ...
    <script>
        (function(w, d, s) {
            ...
            j.async = true;
            j.onload = function() {
                var vt = window.Visit('lpaster_pharma_reg2021');
                window.currentVisit = vt;
                const formEl = document.getElementById('main_form');
                var node = document.createElement("input");
                node.setAttribute('name', 'visitor_id');
                node.setAttribute('type', 'hidden');
                node.setAttribute('value', vt.visitor_id);
                formEl.appendChild(node);
            }
            j.src =
                'https://formanalytica.com/dmt.js?tracking_id=aster_pharma_reg2021'
    ...
    <script>
        (function(w, d, s) {
            ...
            j.async = true;
            j.onload = function() {
                var vt = window.Visit('lpaster_pharma_newsletter_reg2021');
                window.currentVisit = vt;
                const formEl = document.getElementById('subscribe_form');
                var node = document.createElement("input");
                node.setAttribute('name', 'visitor_id');
                node.setAttribute('type', 'hidden');
                node.setAttribute('value', vt.visitor_id);
            ...
            j.src =
                'https://formanalytica.com/dmt.js?tracking_id=aster_pharma_newsletter_reg2021'
            f.parentNode.insertBefore(j, f);
    ...
    <script>
        (function(w, d, s) {
            ...
            j.async = true;
            j.onload = function() {
                var vt = window.Visit('lpaster_pharma_business_reg2021');
                window.currentVisit = vt;
                const formEl = document.getElementById('associate_form');
                var node = document.createElement("input");
                node.setAttribute('name', 'visitor_id');
                node.setAttribute('type', 'hidden');
                node.setAttribute('value', vt.visitor_id);
            ...
            j.src =
                'https://formanalytica.com/dmt.js?tracking_id=aster_pharma_business_reg2021'
            f.parentNode.insertBefore(j, f);
