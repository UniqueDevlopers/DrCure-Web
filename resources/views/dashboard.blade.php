                                ...
                                <div class="col-12">
                                    <div class="media my-2">
                                        ...
                                        <div class="media-body align-self-center ms-2">
                                            ...
                                            <p class="text-muted mb-0">This is a simple hero unit, a simple jumbotron-style
                                                component.</p>
                                        </div><!--end media body-->
                                    </div>
                                </div><!--end col-->
                                        ...
                                        <div class="row">
                                            <div class="col-12 align-self-center">
                                                ...
                                                <div class="media mt-3">
                                                    <img src="assets/images/users/dr-1.jpg" alt="" height="70"
                                                        class="rounded-circle">
                                                    <div class="media-body align-self-center ms-3">
                                                        <h5 class="mt-0 mb-1 font-15">Dr.Helen White</h5>
                                                        <p class="text-muted mb-0"><span class="me-2 text-secondary">MS
                                                                Cardiology</span> 11:00am to 03:00pm</p>
                                                        <ul class="list-inline mb-0">
                                                            ...
                                                            <li class="list-inline-item m-0"><small
                                                                    class="text-muted">4.91/5 (1021 reviews)</small></li>
                                                        </ul>
                                                    </div><!--end media-body-->
                                                </div> <!--end media-->
                                                <hr class="hr-dashed">
                                    ...
                                    <div class="carousel-item">
                                        <div class="row">
                                            <div class="col-12 align-self-center">
                                                ...
                                                <div class="media mt-3">
                                                    <img src="assets/images/users/dr-3.jpg" alt="" height="70"
                                                        class="rounded-circle">
                                                    <div class="media-body align-self-center ms-3">
                                                        <h5 class="mt-0 mb-1 font-15">Dr.Wendy Keen</h5>
                                                        <p class="text-muted mb-0"><span class="me-2 text-secondary">MD
                                                                Neurology</span> 01:00pm to 04:00pm</p>
                                                        <ul class="list-inline mb-0">
                                                            <li class="list-inline-item m-0"><i
                                                                    class="mdi mdi-star text-warning font-16"></i></li>
                                                            <li class="list-inline-item m-0"><i
                                    ...
                                    <div class="carousel-item">
                                        <div class="row">
                                            <div class="col-12 align-self-center">
                                                ...
                                                <div class="media mt-3">
                                                    <img src="assets/images/users/dr-2.jpg" alt="" height="70"
                                                        class="rounded-circle">
                                                    <div class="media-body align-self-center ms-3">
                                                        <h5 class="mt-0 mb-1 font-15">Dr.Lisa King</h5>
                                                        <p class="text-muted mb-0"><span class="me-2 text-secondary">MD
                                                                Orthopedic</span> 09:00am to 11:30am</p>
                                                        <ul class="list-inline mb-0">
                                                            <li class="list-inline-item m-0"><i
                                                                    class="mdi mdi-star text-warning font-16"></i></li>
                                                            <li class="list-inline-item m-0"><i
                            ...
                            <div class="row">
                                <div class="col-md-3 align-self-center">
                                    <div class="text-center">
                                        <div
                                            class="d-flex justify-content-center align-items-center thumb-lg bg-soft-primary rounded-circle mx-auto mb-2">
                                            <i class="las la-procedures align-self-center"></i>
                                        </div>
                                        <h4 class="mt-0 fw-bold">1200</h4>
                                        <h6 class="text-uppercase m-0 mb-2">Admit</h6>
                                        <p class="text-muted font-11"><span class="text-success"><i
                                                    class="mdi mdi-arrow-up"></i>14.5%</span> Up From Last Week</p>
                                        <div class="d-grid">
                                            <button type="button" class="btn btn-soft-primary btn-sm">More
                                                Details</button>
                                        </div>
                                    </div>
                                </div><!--end col-->
                                    ...
                                    <tbody>
                                        <tr>
                                            <td><a href="hospital-patient-profile.html"><img
                                                        src="assets/images/users/user-10.jpg" alt=""
                                                        class="thumb-sm rounded-circle me-2">Donald Gardner</a></td>
                                            <td>36</td>
                                            <td>#1236</td>
                                        ...
                                        <tr>
                                            <td><a href="hospital-patient-profile.html"><img
                                                        src="assets/images/users/user-9.jpg" alt=""
                                                        class="thumb-sm rounded-circle me-2">Keith Jacobson</a></td>
                                            <td>48</td>
                                            <td>#1236</td>
                                            <td>B28 University Street US</td>
                                            <td>+123456789</td>
                                        ...
                                        <tr>
                                            <td><a href="hospital-patient-profile.html"><img
                                                        src="assets/images/users/user-9.jpg" alt=""
                                                        class="thumb-sm rounded-circle me-2">Greg Crosby</a></td>
                                            <td>27</td>
                                            <td>#1236</td>
                                            <td>B28 University Street US</td>
                                            <td>+123456789</td>
                                        ...
                                        <tr>
                                            <td><a href="hospital-patient-profile.html"><img
                                                        src="assets/images/users/user-8.jpg" alt=""
                                                        class="thumb-sm rounded-circle me-2">Fred Godina</a></td>
                                            <td>22</td>
                                            <td>#1236</td>
                                            <td>B28 University Street US</td>
                                            <td>+123456789</td>
                                        ...
                                        <tr>
                                            <td><a href="hospital-patient-profile.html"><img
                                                        src="assets/images/users/user-7.jpg" alt=""
                                                        class="thumb-sm rounded-circle me-2">Peggy Doe</a></td>
                                            <td>51</td>
                                            <td>#7851</td>
                                            <td>B28 University Street US</td>
                                            <td>+123456789</td>
                                        ...
                                        <tr>
                                            <td><a href="hospital-patient-profile.html"><img
                                                        src="assets/images/users/user-8.jpg" alt=""
                                                        class="thumb-sm rounded-circle me-2">Jennifer Doss</a></td>
                                            <td>18</td>
                                            <td>#3654</td>
                                            <td>B28 University Street US</td>
                                            <td>+123456789</td>
